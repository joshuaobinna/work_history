...
const hasDaysLongerThanSixLetters =   week.some(week => week.length > 6 );
...
const filteredDaysLongerThanSixLetters =  week.filter(week => week.length > 6);
...
const arrayOfCapitalizedDays =  week.map(week => week.toUpperCase());
